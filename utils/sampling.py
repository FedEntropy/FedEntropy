...
def non_iid(dataset, args, num_shards, num_imgs):
    if args.noniid_case == 1:
        ...
        return noniid_dirichlet(dataset, args.num_users, args.num_classes, args.data_alpha)
    else:
...
def imagenet_noniid(dataset, args):
    num_shards, num_imgs = 100, 500
    return non_iid(dataset, args, num_shards, num_imgs)

def fashion_mnist_iid(dataset, args):
    return iid(dataset, args)


def fashion_mnist_noniid(dataset, args):
    num_shards, num_imgs = 100, 600
    return non_iid(dataset, args, num_shards, num_imgs)
